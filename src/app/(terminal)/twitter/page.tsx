...
const SIGNALS: Signal[] = [
  {
    ...
    timeAgo: "2 分钟前",
    content:
      "BTC/USD 正在接近主要的 H4 供应区 (64200-64500)。正在观察 M15 级别的结构转变 (MSB)，准备布局做空。 #交易 #SMC",
    asset: "BTC/USD",
    comments: 12,
    retweets: 48,
  },
  {
    ...
    timeAgo: "15 分钟前",
    content:
      "市场正在屏息以待今日晚些时候的 FOMC 利率决议。预计美圆指数相关货币对将出现剧烈波动。",
    asset: "DXY",
    comments: 12,
    retweets: 48,
  },
  {
    ...
    timeAgo: "45 分钟前",
    content:
      "EUR/AUD 流动性扫损已在 1.6234 确认。目标看向本周高点。止损设在当前影线下方。",
    asset: "EUR/AUD",
    comments: 12,
    retweets: 48,
  },
